...
<head>
    ...
    <style>
        ...
        /* HERO */
        .hero-section { background: url('https://images.unsplash.com/photo-1441986300917-64674bd600d8?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80') no-repeat center center/cover; color:white; min-height:70vh; display:flex; align-items:center; position:relative; }
        ...
        .hero-section h1 { font-size:3.5rem; font-weight:700; text-shadow:2px 2px 4px rgba(0,0,0,0.5); animation:fadeInUp 1s ease-out; }
        ...
        .btn-primary { animation: bounce 2s infinite; }
        @keyframes bounce { 0%,100%{ transform:translateY(0);} 50%{ transform:translateY(-5px);} }

        /* FEATURES */
        .features { padding:5rem 0; background:white; }
        .feature-card { padding:2rem; border-radius:15px; box-shadow:0 10px 20px rgba(0,0,0,0.1); transition: transform 0.3s ease, box-shadow 0.3s ease; margin-bottom:2rem; text-align:center; position:relative; overflow:hidden; cursor:pointer; }
        .feature-card::after { content:''; position:absolute; top:0; left:-75%; width:50%; height:100%; background: rgba(255,255,255,0.3); transform: skewX(-25deg); transition: all 0.7s ease; }
        .feature-card.active::after { left:125%; }
        .feature-card:hover { transform: translateY(-10px) rotate(2deg); box-shadow:0 20px 40px rgba(0,0,0,0.2); }
        .feature-card:nth-child(1){ background: linear-gradient(135deg,#6dd5ed,#2193b0); } 
        .feature-card:nth-child(1) i{ color:#fff9c4; }
        .feature-card:nth-child(2){ background: linear-gradient(135deg,#f6d365,#fda085); } 
        .feature-card:nth-child(2) i{ color:#673ab7; }
        .feature-card:nth-child(3){ background: linear-gradient(135deg,#ff9a9e,#fad0c4); } 
        .feature-card:nth-child(3) i{ color:#ff5722; }
        .feature-card:nth-child(4){ background: linear-gradient(135deg,#a1c4fd,#c2e9fb); } 
        .feature-card:nth-child(4) i{ color:#3f51b5; }
        .feature-card h4{ color:#fff; font-weight:600; margin-bottom:1rem; }
        ...
        .product-card { background:white; border-radius:15px; box-shadow:0 10px 20px rgba(0,0,0,0.1); overflow:hidden; transition: transform 0.3s ease, box-shadow 0.3s ease; margin-bottom:2rem; }
        ...
        .product-card .btn { background: linear-gradient(45deg,#ff6b6b,#feca57); border:none; transition: transform 0.3s ease; }
        .product-card .btn:hover { transform: scale(1.05); }
        ...
        #notification button { background: rgba(255,255,255,0.2); border: none; color: #fff; padding: 5px 10px; border-radius: 5px; cursor: pointer; font-weight: 600; transition: background 0.3s ease; }
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="nav">
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item"><a class="nav-link" href="login"><i class="fas fa-user"></i> Login</a></li>
                <li class="nav-item">
...
<section class="hero-section">
    <div class="container">
        ...
        <p>Your one-stop shop for the latest products at unbeatable prices!</p>
        <a href="/shop" class="btn btn-primary btn-lg mt-3">Start Shopping Now</a>
    </div>
</section>
...
<section class="features">
    <div class="container">
        <div class="row text-center">
            <div class="col-md-3" data-aos="fade-up"><div class="feature-card"><i class="fas fa-truck"></i><h4>Fast Delivery</h4><p>Lightning-fast delivery anywhere.</p></div></div>
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="100"><div class="feature-card"><i class="fas fa-lock"></i><h4>Secure Payment</h4><p>100% secure payment gateways.</p></div></div>
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="200"><div class="feature-card"><i class="fas fa-star"></i><h4>Best Quality</h4><p>Top-quality products guaranteed.</p></div></div>
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="300"><div class="feature-card"><i class="fas fa-headset"></i><h4>24/7 Support</h4><p>Dedicated customer support anytime.</p></div></div>
        </div>
    </div>
</section>
...
<!-- Notification -->
<div id="notification">
    <i class="fas fa-bell"></i> New Products Just Arrived!
